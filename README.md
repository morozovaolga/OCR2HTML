...
Команда и параметры
  ...
  - --cover-palette PALETTE — желаемая цветовая гамма обложки (например, «приглушённая»)
  - --cover-era ERA — эпоха или культурные ассоциации для обложки
  - --cover-mood MOOD — настроение, которое должна транслировать обложка
  - --cover-decoration STYLE — тип декоративных элементов / паттернов
